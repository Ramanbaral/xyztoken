...
let tokenContract = new ethers.Contract(contractAddress, contractAbi, signer)
...
async function vestedAmount() {
    console.log("vested Amount " + ethers.utils.formatEther( await tokenContract.vestedAmount() ));
}

async function release() {
    await tokenContract.releaseAllTokens()
}
